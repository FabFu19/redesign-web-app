...
export const News = () => {
    return(
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-[400px_auto] gap-8 py-16">
            <div className="flex flex-col text-[#00000]">
                <h2 className="sm:mt-0 md:mt-[50px] mb-6 uppercase news-text-styles">
                ...
                <div className="bg-[#0072BC] text-white rounded-full px-6 py-3 w-max hover:bg-[#0b649f] cursor-pointer">
                    <p>Read news</p>
                </div>
            </div>
            <div className="flex flex-col">
                <div className="flex space-x-4 overflow-x-auto mb-[36px]">
                    <div className="relative w-[450px] flex-shrink-0 h-[513px] rounded-2xl overflow-hidden bg-gray-100 cursor-pointer">
                        ...
                        <p className="absolute w-full bottom-0 h-[450px] content-end text-white text-sm p-4 bg-gradient-to-b from-transparent to-[#0B3855]">
                            THU., MAY 30 2024
                        </p>
                    </div>
                    <div className="relative w-[160px] h-[513px] flex-shrink-0 rounded-2xl overflow-hidden bg-gray-100 cursor-pointer">
                        ...
                        <p className="absolute inset-0 flex items-end bg-gradient-to-b from-transparent to-[#0B3855] p-4">
                            <span className="text-white text-sm [writing-mode:vertical-rl] rotate-180">TUE., MAY 28 2024</span>
                        </p>
                    </div>
                    <div className="relative w-[160px] h-[513px] flex-shrink-0 rounded-2xl overflow-hidden bg-gray-100 cursor-pointer">
                        ...
                        <p className="absolute inset-0 flex items-end bg-gradient-to-b from-transparent to-[#0B3855] p-4">
                            <span className="text-white text-sm [writing-mode:vertical-rl] rotate-180">MON., MAY 27 2024</span>
                        </p>
                    </div>
                </div>
                <div className="flex flex-row bg-transparent text-[#0072BC] border border-[#0072BC] rounded-full px-6 py-3 ms-auto w-max hover:bg-[#0b649f] hover:text-white cursor-pointer">
                    <p>View all</p>
                </div>
            </div>
        </div>
